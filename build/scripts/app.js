...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modal-demo-01').on('show.nth.modal', function () {
    console.log('Модальное окно #modal-demo-01: сработало событие show.nth.modal'); // eslint-disable-line no-console
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modal-demo-01').on('shown.nth.modal', function () {
    console.log('Модальное окно #modal-demo-01: сработало событие shown.nth.modal'); // eslint-disable-line no-console
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modal-demo-01').on('hide.nth.modal', function () {
    console.log('Модальное окно #modal-demo-01: сработало событие hide.nth.modal'); // eslint-disable-line no-console
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modal-demo-01').on('hidden.nth.modal', function () {
...
+function ($) {
  ...
  Modal.prototype.show = function (_relatedTarget) {
    ...
    this.backdrop(function () {
      ...
      that.$element // .show()
      .css('display', 'flex').scrollTop(0); // that.adjustDialog()
      // if (transition) {
